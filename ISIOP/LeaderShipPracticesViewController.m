//
//  LeaderShipPracticesViewController.m
//  TestTabController1
//
//

#import "LeaderShipPracticesViewController.h"
...
@interface LeaderShipPracticesViewController ()

@end

@implementation LeaderShipPracticesViewController
{
...
+ (LeaderShipPracticesViewController *)sharedInstance
{
    ...
    static LeaderShipPracticesViewController *myInstance = nil;
...
- (void)viewDidLoad
{
    ...
    {
        self.navItem.title = @"Post-Observation: Leadership Practices";
    }
    else
    {
        NSMutableString *myString = [NSMutableString stringWithString:vs.gClassID];
        [myString appendString:@" - "];
        [myString appendString:@"Post-Observation: Leadership Practices"];
...
-(void)loadPreviousObservation
{
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"observationID=%@ and sectionName=%@",observationID,@"LeadershipPractices"];
...
-(void)loadQuestions
{
    ...
    o1.questionText = @"The teacher facilitated a learning-conducive physical environment for the majority of the students";
    o1.questionType = @"drop";
    o1.questionID = [NSNumber numberWithInt:15];
    o1.questionResult = @"Select Item";
    
    ObservationQuestion *o2 = [[ObservationQuestion alloc]init];
    o2.questionText = @"The teacher projected a welcoming and engaging teaching style";
    o2.questionType = @"drop";
    o2.questionID = [NSNumber numberWithInt:16];
    o2.questionResult = @"Select Item";
    
    
    ObservationQuestion *o3 = [[ObservationQuestion alloc]init];
    o3.questionText = @"The teacher utilized teaching approaches to push students’ thinking farther and encouraged flexibilityin their thinking";
    o3.questionType = @"drop";
    o3.questionID = [NSNumber numberWithInt:17];
    o3.questionResult = @"Select Item";
    
    ObservationQuestion *o4 = [[ObservationQuestion alloc]init];
    o4.questionText = @"The teacher stated the learning goals (i.e., the science content students would learn)";
    o4.questionType = @"drop";
    o4.questionID = [NSNumber numberWithInt:18];
    o4.questionResult = @"Select Item";
    
    
    
    NSArray *questions1Array = [NSArray arrayWithObjects:o1, o2,o3,o4, nil];
...
- (BOOL)tabBarController:(UITabBarController *)tbc shouldSelectViewController:(UIViewController *)vc
{
    ...
    else
    {
        if (bDataSaved == NO || bIsModified == YES)
        {
            ...
            saveAlert.message = @"Save this Leadershp Practices Information?";
...
-(void)buttonAction:(ButtonControlExt *)sender
{
   // UIButton *button = (UIButton *)sender;
    ...
    //Segment*ontrolExt *segCont = (Segment*ontrolExt *)sender;
    ...
    if ([self isDataValid] == YES)
    {
        ...
        for (ObservationQuestion *oq in array)
        {
            ...
            if(bDataSaved == NO)
            {
                ...
                [ob setSectionName:@"LeadershipPractices"];
            ...
            else
            {
                ...
                NSPredicate *predicate = [NSPredicate predicateWithFormat:@"observationID=%@ and sectionName=%@ and poqID=%@",observationID,@"LeadershipPractices",oq.questionID];
            ...
            else
            {
                ...
                if([self connectedToNetwork] == YES)
                {
                    ...
                    [parms setObject:@"LeadershipPractices" forKey:@"SectionName"];
        ...
        if(bNoError == YES)
        {
            ...
            saveAlert.delegate = self;
            saveAlert.title = @"ISIOP";
            saveAlert.message = @"The Leadership Practices data has been saved.";
